...
This package parses and validates chart/machine data — plain strings and
JSON you hand it. It runs no server, opens no socket, and sends nothing
anywhere.
...
[GitHub's security advisories](https://github.com/alrayyes/washy-washy-sdk/security/advisories/new)
